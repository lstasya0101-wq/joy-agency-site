...
export default function ContactForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const message = `Contact inquiry with event details:
      
Date preference: ${contactForm.month ? `${contactForm.month} ${contactForm.day}` : "Not specified"}
Optional day type: ${contactForm.optionalDay || "Not specified"}
Number of children: ${contactForm.amountKids || "Not specified"}
Program interest: ${contactForm.program || "Not specified"}`;
      ...
      const formspreeData: FormspreeFormData = {
        ...
        eventDate:
          contactForm.month && contactForm.day
            ? `${contactForm.month} ${contactForm.day}`
            : undefined,
        numberOfKids: contactForm.amountKids || undefined,
        preferredTime: contactForm.optionalDay || undefined,
        programChoice: contactForm.program || undefined,
      };
